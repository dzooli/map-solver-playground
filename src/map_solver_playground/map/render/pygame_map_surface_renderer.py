"""
Pygame implementation of the BaseMapSurfaceRenderer interface.
"""
...
class PygameMapSurfaceRenderer(BaseMapSurfaceRenderer):
    ...
    This class provides methods for converting map data to pygame surfaces
    and applying visual effects.
    """
    
    @staticmethod
    def to_surface(map_obj: Map) -> pygame.Surface:
        """
        Convert a map to a pygame surface suitable for drawing.
        
        Args:
            map_obj: The map to convert
            
        Returns:
            pygame.Surface: A pygame surface representing the map
        """
    ...
    def color_map(surface: pygame.Surface, color_map_array: TerrainColorGradient) -> pygame.Surface:
        ...
        Returns:
            pygame.Surface: A new pygame surface with mapped colors
        """
    ...
    def scale(surface: pygame.Surface, width: int, height: int) -> pygame.Surface:
        ...
        Returns:
            pygame.Surface: The scaled pygame surface
        """
